...
Wan2.2 TI2V-5B extended with **CLIP motion transfer**: extract motion from a driver video and apply it to a new image (i2v).

| Doc | Description |
|-----|-------------|
| [motion_transfer.md](motion_transfer.md) | Train & infer quick start |
| [PIPELINE.md](PIPELINE.md) | Architecture and data flow |

**Scripts:** `train_motion.py`, `generate_motion.py`, `extract_motion.py` — module: `wan/modules/motion_transfer/`
